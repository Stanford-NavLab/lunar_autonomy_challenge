...
def dR_dalpha(alpha, beta, gamma):
    row1 = [-np.sin(alpha)*np.cos(beta), -np.sin(alpha)*np.sin(beta)*np.sin(gamma)-np.cos(alpha)*np.cos(gamma), -np.sin(alpha)*np.sin(beta)*np.cos(gamma)+np.cos(alpha)*np.sin(gamma)]
    row2 = [np.cos(alpha)*np.cos(beta), np.cos(alpha)*np.sin(beta)*np.sin(gamma)-np.sin(alpha)*np.cos(gamma), np.cos(alpha)*np.sin(beta)*np.cos(gamma)+np.sin(alpha)*np.sin(gamma)]
    row3 = [0, 0, 0]
    return np.array([row1, row2, row3])

def dR_dbeta(alpha, beta, gamma):
    row1 = [-np.cos(alpha)*np.sin(beta), np.cos(alpha)*np.cos(beta)*np.sin(gamma), np.cos(alpha)*np.cos(beta)*np.cos(gamma)]
    row2 = [-np.sin(alpha)*np.sin(beta), np.sin(alpha)*np.cos(beta)*np.sin(gamma), np.sin(alpha)*np.cos(beta)*np.cos(gamma)]
    row3 = [-np.cos(beta), -np.sin(beta)*np.sin(gamma), -np.sin(beta)*np.cos(gamma)]
    return np.array([row1, row2, row3])

def dR_dgamma(alpha, beta, gamma):
    row1 = [0, np.cos(alpha)*np.sin(beta)*np.cos(gamma)-np.sin(alpha)*np.sin(gamma), -np.cos(alpha)*np.sin(beta)*np.sin(gamma)-np.sin(alpha)*np.cos(gamma)]
    row2 = [0, np.sin(alpha)*np.sin(beta)*np.cos(gamma)+np.cos(alpha)*np.sin(gamma), -np.sin(alpha)*np.sin(beta)*np.sin(gamma)+np.cos(alpha)*np.cos(gamma)]
