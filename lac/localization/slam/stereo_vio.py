"""Stereo Visual-Inertial Odometry with LightGlue frontend and SymForce backend"""
...
class StereoVIO:
    ...
    def triangulate_points(self, pose: np.ndarray, left_image: np.ndarray, right_image: np.ndarray):
        ...
        points0_world = apply_transform(pose, points0_rover)

        return points0_world, matched_kps0_left
